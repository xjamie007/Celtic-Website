  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Desktop ─────────────────────────────────────────────────── */}
        <nav aria-label={tA11y("mainNav")} className="ml-auto hidden lg:block">
              ...
              return (
                <li key={item.key} className="group relative">
                  <Link
                    ...
                    className={cn(
                      "text-ui-sm block px-3 py-2 transition-colors duration-200",
                      active
                        ? "text-[var(--nav-fg)]"
      ...
      <div
        ...
        inert={!menuOpen}
        className={cn(
          "bg-ink fixed inset-x-0 top-14 bottom-0 overflow-y-auto transition-opacity duration-200 lg:hidden",
            ...
            {nav.map((item) => (
              <li key={item.key} className="py-1">
                <Link
                  ...
                  className={cn(
                    "text-h3 wdth-100 block py-2 font-display",
